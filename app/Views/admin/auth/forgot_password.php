...
<head>
    ...
    <title>Forgot Password — Product Gallery</title>
        ...
        <div class="col-md-5 col-lg-4">
            <div class="auth-card card p-4 shadow-lg">
                <div class="card-body">
                    ...
                    <form action="/admin/forgot-password" method="post" id="forgotForm">
                        <?= csrf_field() ?>
                        <div class="mb-4">
                            <label class="form-label">Admin Email Address</label>
                            <input type="email" name="email" class="form-control" value="<?= esc(old('email')) ?>" required autofocus>
                        </div>
                        <button type="submit" class="btn btn-indigo w-100 py-2" id="submitBtn">Send Reset Link</button>
                    </form>
